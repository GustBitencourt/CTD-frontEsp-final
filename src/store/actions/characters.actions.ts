import { Api, Character, Episode, ActionType } from '../../types'

export const FETCH_CHARACTERS_START = "FETCH_CHARACTERS_START";
export const FETCH_CHARACTERS_SUCCESS = 'FETCH_CHARACTERS_SUCCESS';
export const FETCH_CHARACTERS_ERROR = 'FETCH_CHARACTERS_ERROR';
export const FAVORITAR_CHARACTERS = "FAVORITAR_CHARACTERS";
export const FETCH_CHARACTER_ID_SUCCESS = "FETCH_CHARACTER_ID_SUCCESS";
export const FETCH_EPISODES = "FETCH_EPISODES";

/**
 * Função para iniciar API e fazer um carregamento na página
 * @function fetchCharactersStarted
 * @returns { ActionType } só retorna um estado que já estava (...state) e isFetching: true
 */
export const fetchCharactersStarted = (): ActionType => {
    return { type: FETCH_CHARACTERS_START };
};

/**
 * Função para pegar os personagens e paginação na API
 * @function fetchCharacterSuccess
 ...
 */
export const fetchCharacterSuccess = (data: Api): ActionType => {
    return {
 ...
 * @function fetchCharacterError
 * @param { string } errorMessage mensagem de erro
 * @returns { ActionType } retorna o payload com a string da mensagem de erro
 */
export const fetchCharacterError = (errorMessage: string): ActionType => {
    return {
 ...
 */
export const favoritarCharacters = (id: number): ActionType => {
    return { 
        type: FAVORITAR_CHARACTERS,
        payload: id,
    }
}
 ...
 * @function fetchCharacterIDSuccess
 * @param { Character } character parametro do tipo { Personagem }
 * @returns { ActionType } retorna um payload do tipo Personagem
 */
export const fetchCharacterIDSuccess = (character: Character): ActionType => {
    return {
        type: FETCH_CHARACTER_ID_SUCCESS,
        payload: { character },
    }
}
...
export const fetchCharacterThunk = () => async (dispatch: any) => {
    ...
    try {
        ...
        const jsonFilter = json.results.map((result: Character) =>  ({...result, favorito: false}))      
        dispatch(fetchCharacterSuccess({info: json.info, results: jsonFilter}));                  
 ...
 */
export const filterCharacterThunk = (texto: string) => async (dispatch: any) => {
    dispatch(fetchCharactersStarted());
    try {
